							...
							<div className="container">
								<div className="col-lg-12 autoresponder-header">
                                 ...
                                 <div className="col-lg-5 margin-bottom pt-4" >
                                    <button className="btn btn-primary p-2 mb-3" data-toggle="modal" data-target="#addNewSeries">Add a new Series</button>
                                    <p style={{fontSize:'18px'}}>No autoresponse email series created yet.</p>
