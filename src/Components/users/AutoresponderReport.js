                                            ...
                                            <div className="col-lg-12 pl-5 pr-5">
                                                <h5>All Reports</h5>
                                                    <div className="table-responsive">
                                                        <table id="example" className="table table-bordered text-nowrap w-100" >
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td>
                                                                        <p>Congratulations! You've successfully created an account.</p>
                                                                        <p>10 Recipients    0% Open Rate  0% Click Rate</p>
                                                                    </td>
                                                                    <td style={{textAlign:'center'}} className="pt-4">
                                                                        <i className="fa fa-eye eye-icon" aria-hidden="true"></i>
                                                                        <i className="fa fa-trash trash-icon" aria-hidden="true"></i>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
