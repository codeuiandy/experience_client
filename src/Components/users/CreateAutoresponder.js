                    	...
                    	<div className="row">
							<div className="container">
								...
								<div className="col-lg-12 text-right mt-4">
									<button className="btn btn-primary p-2 mr-2">Existing Email Series</button>
									<button className="btn btn-secondary p-2 mr-2">Reports</button>
									<button className="btn btn-outline-primary p-2">Setting</button>
                                </div>
                                    ...
                                    <div className="autoresponder-form">
                                        <form>
                                            <div className="form-group">
                                                <label>Sender:</label>
                                                <input type="text" className="form-control payment-input" placeholder="opeyemiemma@gmail.com" />
                                            </div>
                                            <div className="form-group">
                                                <label>Subject:</label>
                                                <input type="text" className="form-control payment-input" placeholder="Enter Email Subject.." />
                                            </div>
                                            <div className="form-group">
                                                <label>Body:</label>
                                            ...
                                            <div className="col-lg-12 margin-bottom text-right pt-4 pr-0">
												<button className="btn btn-outline-primary p-2 mr-2">Back</button>
