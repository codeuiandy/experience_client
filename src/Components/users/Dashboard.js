								...
								<div className="row">
											...
											<div className="col-lg-4">
												<div className="card text-left">
													<img
														...
														alt="gallery-img"
														data-text="Gallery-Image01"
													/>
													<div className="content">
														<Link to="/user_event_details" className="bold">
															Harvard Luncheon
														</Link>
														<p>
															<span className="bold">Location</span>{" "}
															<span>Ground Zero Central Park</span>
														</p>
														<p>
									...
									<div className="col-lg-3 col-sm-12 col-md-3">
										...
										<ul className="published">
											<li>
												<Link className="list" to="/user_event_details">
													Havard Launcheon
												</Link>
											</li>
											<li>
