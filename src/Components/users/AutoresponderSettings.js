                                ...
                                <div class="col-lg-12 pt-4">
                                    <div class="row">
										<div class="col-lg-10 pr-5">
											<div>
												<p>A verification is required to add a new email asdress. Look out for a verification link in your business!</p>
												<p class="note-info">Note that mails will not be sent if you choose an unverified email as your sender address. Yahoo.com and icloud.com are not advised for sender email address.</p>
											</div>
											<div>
												<form class="form-horizontal">
													<div class="row form-group ">
														<label class="col-lg-2 col-sm-12 pt-3">Email List : </label>              
													...
													<div class="row form-group ">
														<label class="col-lg-2 col-sm-12 pt-3">Sender Email : </label>              
														<select class="form-control payment-input col-lg-10 col-sm-12" >
															<option>--Select An Email Address--</option>
															<option>peace@gmail.com</option>
															<option>gift@gmail.com</option>
													...
													<div class="col-lg-12 margin-bottom pt-4" style={{textAlign: 'center'}}>
														<button class="btn btn-primary p-2 mr-3">Back</button>
														<button class="btn btn-outline-primary p-2">Save Changes</button>
													</div>
												</form>
											</div>
										</div>
										<div class="col-lg-2">
											<button class="btn btn-default delete-autoresponder">Delete Autoresponse</button>
										</div>
									</div>
                                </div>
