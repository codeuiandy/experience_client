							...
							<div className="col-lg-12 col-sm-12 col-md-12">
									...
									<div className="col-lg-12">
										<div className="row">
											...
											<div className="col-lg-6 text-right">
												<Link to="/user_dashboard">Return to Dashboard</Link>
											</div>
										</div>
									</div>
								...
								<div className="row">
									<div className="col-lg-8">
										<h3 style={{paddingTop:'20px'}}><span className="bold">Events</span> : Havard Launcheon</h3>
								...
								<div className="row margin-top">
									...
									<div className="col-lg-8">
										<div className="card text-left">
											...
											<canvas id="Chart2" className="h-400 overflow-hidden"></canvas>
											</div>
										</div>
									</div>
									...
									<div className="col-lg-3">
										<div className="card">
											<div className="card-body">
												...
												<h2 className="font-medium text-primary m-t-20 m-b-20"><img src={attendees_img} /> <span className="pull-right">26785</span></h2>
											</div>
										</div>
												...
												<div className="row mb-0">
													<div className="col-12">
														<div className="dash3 text-center">
															<small className="text-muted mt-0">% Check In : 85%</small><br/>
														</div>
													</div>
													<div className="col-12">
														<div className="card-icon d-flex" style={{justifyContent: 'center', paddingTop: '40px'}}>
															<input type="text" className="knob" value="85" data-thickness="0.2" data-width="160" data-height="160" data-fgColor="#5d61bf" />
														</div>
													</div>
									...
									<div className="col-lg-3">
										<div className="card">
											<div className="card-body">
												...
												<h2 className="font-medium text-primary m-t-20 m-b-20"><img src={team_1_img} /> <span className="pull-right">26785</span></h2>
											</div>
										</div>
									</div>
									<div className="col-lg-3">
										<div className="card">
											<div className="card-body">
												...
												<h2 className="font-medium text-primary m-t-20 m-b-20"><img src={museum_img} /> <span className="pull-right">500</span></h2>
											</div>
										</div>
									</div>
									<div className="col-lg-3">
										<div className="card">
											<div className="card-body">
												...
												<h2 className="font-medium text-primary m-t-20 m-b-20"><img src={tv_img} /> <span className="pull-right">500</span></h2>
											</div>
										</div>
									</div>
									<div className="col-lg-3">
										<div className="card">
											<div className="card-body">
												...
												<h2 className="font-medium text-primary m-t-20 m-b-20"><img src={team_2_img} /> <span className="pull-right">500</span></h2>
											</div>
										</div>
									</div>
								</div>
										...
										<div className="card-body">
											...
											<div className="card-progressbar">
												<div className="progress h-6 mt-1">
													<div className="progress-bar bg-warning w-70" role="progressbar"></div>
												</div>
											</div>
											<div className="clearfix mt-3">
											...
											<div className="card-progressbar">
												<div className="progress h-6 mt-1">
													<div className="progress-bar bg-orange w-30" role="progressbar"></div>
												</div>
											</div>
											<div className="clearfix mt-3">
											...
											<div className="card-progressbar">
												<div className="progress h-6 mt-1">
													<div className="progress-bar bg-success w-30" role="progressbar"></div>
												</div>
											</div>
											...
											<table className="table table-bordered text-nowrap mb-0">
												...
												<tbody>
													...
													<tr>
														...
														<td>$15,100</td>
														<td>Cash on delivered</td>
														<td><span className="badge badge-cyan">Delivering</span></td>
													</tr>
													<tr>
														<td>#05</td>
														<td>Kevin James</td>
													...
													<tr>
														...
														<td>$4,700</td>
														<td>Online Payment</td>
														<td><span className="badge badge-info">Add to Cart</span></td>
													</tr>
													<tr>
														<td>#08</td>
														<td>Kevin Glover</td>
														...
														<td>$678</td>
														<td>Cash On delivered</td>
														<td><span className="badge badge-pink">Delivered</span></td>
													</tr>
												</tbody>
											</table>
										</div>
