    ...
    <nav className="navbar navbar-expand-lg main-navbar">
					...
					<ul className="navbar-nav navbar-right">
						<li className="dropdown">
							<Link to="#" data-toggle="dropdown" className="nav-link dropdown-toggle nav-link-lg">
								<img src={prof_img_placeholder} alt="profile-user" className="rounded-circle w-32" />
							</Link>
